...
#             {{ img_form.hidden_tag()}}
#             {% for error in img_form.photo.errors%}
#             <span style="color:red">{{error}}</span>
#             {%endfor%}

#             <div class="row justify-content-center">
#                 <div class="col-auto">
#                     {{img_form.photo(class="form-control")}}
#                 </div>
#                 <div class="col-auto">
#                     {{img_form.submit(class="btn btn-success")}}
#                 </div>
#             </div>
#         </form>
...
def show_create(user_id):
    ...
    return render_template('create_wishlist.html',user=user, log = log)
...
def show_edit_wlist(wishlist_id):
    ...
    return render_template('edit_wishlist.html',user=user,wlist = wlist, log = log)
